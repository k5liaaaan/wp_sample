...
<title><?php require "include/site-name.php"; ?>|記事一覧</title>
...
<div id="main">
		...
		<h2 class="archiveTitle">Category</h2>
		...
		<?php 
		//type=yearly → type=monthlyへ変更すれば月別に表示できます。
		//show_post_count=1を消せば右側の投稿件数を消せます。
		 ?>
