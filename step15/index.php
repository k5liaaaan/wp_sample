...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/index.css" type="text/css" media="screen,tv" />
	...
	<div id="main">
		<div class="slider-frame">
			...
			<ul class="slider">
				...
				<li><img src="<?php echo get_template_directory_uri(); ?>/img/sample02.jpg" alt="イメージ2" /></li>
			</ul>
		</div>
